...
#ifndef LD19_LIDAR_ASYNCSERIAL
#define LD19_LIDAR_ASYNCSERIAL
...
public:
  ...
  AsyncSerial(
    ...
    boost::asio::serial_port_base::character_size opt_csize = boost::asio::serial_port_base::character_size(
      8),
